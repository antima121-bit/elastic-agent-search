...
**Author:** Antima Mishra, SDET  
**Published:** February 5, 2026  

---

> **Contest Disclosure:** This blog post was submitted to the Elastic Blog-a-thon Contest and is eligible to win a prize.

---

## Abstract

This article chronicles my journey building an intelligent product search assistant using Elasticsearch's vector search capabilities, semantic embeddings, and RAG (Retrieval Augmented Generation). I'll walk you through implementing hybrid search that combines traditional keyword matching with vector similarity, integrating Google Gemini for natural language understanding, and achieving 9.1/10 relevance scores. You'll see real code, architecture decisions, performance benchmarks, and the mistakes I made along the way—all backed by a complete open-source implementation.
...
I've put everything on GitHub: **https://github.com/antima121-bit/elastic-agent-search**
...
**Quick start:**
```bash
git clone https://github.com/antima121-bit/elastic-agent-search
...
1. **Vector search + LLMs = powerful combination** - Semantic understanding beats keyword matching for natural language queries
2. **Hybrid search is the sweet spot** - Combining BM25 and kNN gives you the best of both worlds (9.1/10 relevance in my tests)
3. **Elasticsearch is production-ready** - No need for specialized vector databases if you're already using Elastic Stack
4. **Model selection matters** - `all-MiniLM-L6-v2` balanced speed and accuracy perfectly for my use case
5. **Tuning is critical** - Spend time on RRF parameters and prompt engineering—it makes a huge difference
...
- [My GitHub repo](https://github.com/antima121-bit/elastic-agent-search)
...
*Questions? Want to chat about vector search? Feel free to reach out! I love talking about this stuff.*

---

**Suggested Hashtags:** #ElasticBlogathon #SearchWithVectors #StoriesInSearch #SmartSearchElastic #VectorsInAction #BeyondKeywords #ElasticDevDiaries #YouKnowForSearch
